...
jgcricol <- function(palx=NULL, alpha=NULL) {
  ...
  pal_all <- c(
    ...
    oil = "firebrick4",
    liquids="firebrick4",
    `refined liquids` = "firebrick4",
    `1 liquids` = "firebrick4",
    ...
    `g Biomass` = "darkolivegreen",
    `g Bioenergy` = "darkolivegreen",
    `d biomass` = "darkolivegreen",
    `4 biomass` = "darkolivegreen",
    Biomass = "darkolivegreen",
    bioenergy = "darkolivegreen",
    `d bioenergy` = "darkolivegreen",
    Bioenergy = "darkolivegreen",
    `Biomass CCS` = "darkolivegreen2",
    `d biomass CCS` = "darkolivegreen2",
    `h Bioenergy w/CCS` = 'darkolivegreen2',
    `j traditional bioenergy` = "chartreuse3",
    `traditional bioenergy` = "chartreuse3",
    `biomass (IGCC CCS)` = "olivedrab2",
    `biomass (IGCC)` = "olivedrab",
    `biomass (conv CCS)` = "darkolivegreen2",
    ...
    `h Biomass w/CCS` = "darkolivegreen2",
    `i Nuclear` = "#ef8e27",
    `e nuclear` = "#ef8e27",
    nuclear = "#ef8e27",
    Gen_II_LWR = "#ef8e27",
    Gen_III = "#af8e27",
    `j Geothermal` = "darkmagenta",
    `i geothermal` = "darkmagenta",
    geothermal = "darkmagenta",
    `k Hydro` = "#3d86f9",
    `f hydro` = "#3d86f9",
    hydro = "#3d86f9",
    `l Wind` = "#fdd67b",
