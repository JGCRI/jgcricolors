...
par(mfrow=c(1,2))
pie(rep(1,length(mypal2)),label=names(mypal1),col=mypal1, main="Pal 1 Missing Colors") # Plot as pie chart
pie(rep(1,length(mypal2)),label=names(mypal2),col=mypal2, main="Pal 2 Added Colors") # Plot as pie chart
```
